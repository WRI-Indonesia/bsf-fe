      ...
      <main className="w-full flex flex-col 2xl:justify-center">
          ...
          <div className="max-w-[1280px] mx-auto">
            <div className="flex flex-col gap-10">
              <nav
                ...
                className="mt-4 mb-6 flex items-center gap-5 text-sm text-text-grey-dark"
              >
                <Link
                  href="/"
                  className="font-[inter] text-text-grey-mid font-medium hover:underline leading-[22px]"
                >
                  Home
                </Link>
                ...
                <span className="text-text-grey-dark">/</span>
                <span className="font-[inter] font-medium text-text-green leading-[22px]">
                  Past Events
                </span>
              </nav>
        ...
        <section className="flex bg-text-white-broken px-20 py-30 2xl:justify-center">
          <div className="flex flex-col max-w-[1280px] mx-auto gap-20">
            <div className="grid gap-[48px] grid-flow-row md:grid-cols-1 md:gap-y-[60px] lg:grid-cols-2 lg:gap-x-[60px] lg:gap-y-[72px]">
              {(pastEvents as unknown as pastEvent[]).map(
                (event: pastEvent) => {
                        ...
                        <div className="flex flex-col text-text-grey-dark">
                          <div className="flex items-center gap-2">
                            <Image
                              ...
                              height={16}
                            />
                            <span className="font-[inter] font-semibold text-text-grey-mid truncate">
                              {event.location}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Image
                              ...
                              height={16}
                            />
                            <span className="font-[inter] font-semibold text-text-grey-mid">
